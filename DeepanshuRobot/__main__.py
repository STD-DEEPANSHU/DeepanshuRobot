...
from DeepanshuRobot.modules import ALL_MODULES
from DeepanshuRobot.modules.helper_funcs.chat_status import is_user_admin
from DeepanshuRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💞 ᴀʙᴏᴜᴛ ᴍᴇ​​ 💞", callback_data="deepanshu_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DeepanshuRobot.modules." + module_name)
...
def Deepanshu_about_callback(update: Update, context: CallbackContext):
    ...
    elif query.data == "deepanshu_back":
        query.message.edit_text(
            PM_START_TEXT.format(dispatcher.bot.first_name),
            reply_markup=InlineKeyboardMarkup(buttons),
            parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ,*\n\n*ᴛʜɪs ɪs Ɗᴇᴇᴘᴀɴꜱʜᴜ ʀᴏʙᴏᴛ*\n\n*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/STD-DEEPANSHU/DeepanshuRobot)\n\n*ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs ɪɴ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴀɴᴅ ɴᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ʏᴇᴛ*\n*sᴏ ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ʀᴇǫᴜᴇsᴛ ᴀɴʏ ғᴇᴀᴛᴜʀᴇ, ᴩʟᴇᴀsᴇ ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ* [STD FRIENDS GROUP](https://t.me/best_friends_chat_group) *ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴩᴇʀ :* [Ɗᴇᴇᴘᴀɴꜱʜᴜ](https://t.me/Deepanshu_Meena09)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                ...
                caption="Ɗᴇᴇᴘᴀɴꜱʜᴜ ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ Ɗᴇᴇᴘᴀɴꜱʜᴜ ᴍᴇᴇɴᴀ 🥀",
            )
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(
        Deepanshu_about_callback, pattern=r"deepanshu_"
    )
