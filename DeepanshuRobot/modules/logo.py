...
from DeepanshuRobot import OWNER_ID
from DeepanshuRobot.events import register
from DeepanshuRobot import telethn
...
async def lego(event):
    ...
    if event.sender_id != OWNER_ID and not quew:
        ...
        return
    pesan = await event.reply("ʟᴏɢᴏ ᴄʀᴇᴀᴛᴇ ʙʏ [Ɗᴇᴇᴘᴀɴꜱʜᴜ](t.me/DEEPANSHU_ROBOT")
    try:
        ...
        fillcolor = "black"
        shadowcolor = "blue"
        fnt = glob.glob("./DeepanshuRobot/resources/fonts/*")
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"ʟᴏɢᴏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Ɗᴇᴇᴘᴀɴꜱʜᴜ ʀᴏʙᴏᴛ"
        )
        await pesan.delete()
...
__help__ = """
Deepanshu Robot can create some beautiful and attractive logo for your profile pics.
